    ...
    <div className={style.wrapper}>
      ...
      <Container fluid className={style.topImage}>
        ...
        <p>
          ...
          uciekłaś myślami, wróć do swojego oddechu”. To MEditate jest storzone
          z myślą o Tobie.
        </p>
        <Link to='/home'>
      ...
      <Container fluid className={style.secondContainer}>
        <h1>Jak to działa?</h1>
        <p>
          W MEditate, z dostępnych komponentów takich jak czas trwania, dźwięk w
          tle czy prowadzenie głosowe ułożysz medytację dopasowaną idealnie do
