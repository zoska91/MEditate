...
const MenuBar = () => {
  return (
    <Navbar collapseOnSelect expand='lg' fixed='top' className={style.menu}>
      <Navbar.Brand>
        <img
          src='https://res.cloudinary.com/dgm1ulzgm/image/upload/v1622367259/MEditate/logo-meditate_odzawz.png'
      ...
      <Navbar.Collapse id='responsive-navbar-nav'>
        <Nav className='ml-auto'>
          <Nav.Link className={style.menuLink} href='/my-meditations'>
            Moje Medytacje
          </Nav.Link>
